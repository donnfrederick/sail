...
const TeachersProfileEditNamePreference = dynamicLoader(() =>
  import('components/pages/teachers/Profile/EditNamePreference')
)
  ...
  withMe(() => (
    <Container id="container">
      ...
      <Switch>
        ...
        <Route
          exact={true}
          path="/teachers/profile/edit/name_preference"
          component={TeachersProfileEditNamePreference}
        />
        <Route
          exact={true}
