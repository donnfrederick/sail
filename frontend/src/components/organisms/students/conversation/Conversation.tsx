...
export default withConversationId((props: Props) => {
  ...
  const partnerName: string = partner
    ? getPreferredName(partner, 'partner')
    : ''

  const myName: string = me ? getPreferredName(me, 'student') : ''
  ...
  return (
    <Container>
      ...
      <Nametag name={partnerName} person_type={'partner'} />
      <Nametag name={myName} person_type={'self'} />
      {closeSoon ? (
