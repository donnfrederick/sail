ActiveAdmin.register Teacher do
  ...
  permit_params :username, :name_ja, :name_en, :preferred_name, :sex, :phone_number,
  ...
  csv force_quotes: true do
    ...
    column :registered_at
    column :name
    column :preferred_name, &:preferred_name_ja
    column :email
    column :sex, &:gender
  ...
  show do
    attributes_table do
      ...
      row :name
      row :preferred_name do |c|
        User::NAME_PREFERENCES_FOR_ADMIN[c.preferred_name]
      end
      row :phone_number
      row :email
      row :sex do |c|
  ...
  form do |f|
    ...
    f.inputs 'User Details' do
      ...
      f.input :preferred_name, as: :select, 
                               collection: User::NAME_PREFERENCES_FOR_ADMIN.invert,
                               include_blank: false
      f.input :email
