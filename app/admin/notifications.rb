ActiveAdmin.register Notification do
  ...
  permit_params :scope, :send_type, :notificated_at, :title_ja, :title_en, 
  ...
  filter :send_type, as: :select,
    collection: Notification::SELECT_SNED_TYPES.invert, include_blank: false
  filter :title_ja
  filter :title_en
  filter :body_ja
  filter :body_en
