# == Schema Information
#
# Table name: ambush_conversations
#
...
# Indexes
#
#  index_ambush_conversations_on_conversation_id  (conversation_id)
#  index_ambush_conversations_on_end_at           (end_at)
#  index_ambush_conversations_on_start_at         (start_at)
#  index_ambush_conversations_on_user_id          (user_id)
#
