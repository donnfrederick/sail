...
#  deleted_at              :datetime
#  discommunication_count  :integer          default(0)
#  feedback_count          :integer          default(0)
#  lateness_count          :integer          default(0)
#  negative_feedback_count :integer          default(0)
#  no_video_count          :integer          default(0)
#  noisy_place_count       :integer          default(0)
...
# Indexes
#
#  index_users_grades_on_grade_id  (grade_id)
#  index_users_grades_on_user_id   (user_id)
#
