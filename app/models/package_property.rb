# == Schema Information
#
# Table name: package_properties
#
#  id                     :bigint           not null, primary key
#  bonus_conversations    :integer          default(0), not null
#  currency               :string(255)      default("usd"), not null
#  deleted_at             :datetime
#  discounted_price       :string(255)
#  duration               :integer          default(1)
#  expired_at             :datetime
#  original_conversations :integer          default(0), not null
#  original_price         :string(255)      default("0"), not null
#  term                   :string(255)      default("month")
