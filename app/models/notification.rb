...
class Notification < ApplicationRecord
  ...
  SEND_TYPES = [
    SEND_MAIL_AND_PUSH = 0.freeze,
    SEND_MAIL_ONLY = 1.freeze,
    SEND_PUSH_ONLY = 2.freeze,
  ].freeze

  SELECT_SNED_TYPES = {
    SEND_MAIL_AND_PUSH => "メール・プッシュ両方".freeze,
    SEND_MAIL_ONLY => "メール通知のみ".freeze,
    SEND_PUSH_ONLY => "プッシュ通知のみ".freeze,
  }.freeze
