...
#  deleted_at              :datetime
#  encrypted_email         :string(191)      not null
#  encrypted_phone_number  :string(191)
#  fcm_token               :string(191)
#  official_position       :string(191)
...
# Indexes
#
#  index_organization_staffs_on_auth_token               (auth_token)
#  index_organization_staffs_on_encrypted_email          (encrypted_email)
#  index_organization_staffs_on_organization_section_id  (organization_section_id)
#
