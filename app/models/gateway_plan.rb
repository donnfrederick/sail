...
#  data_id             :string(191)
#  gateway_product_id  :bigint
#  package_property_id :bigint
#
# Indexes
#
#  index_gateway_plans_on_gateway              (gateway)
#  index_gateway_plans_on_gateway_product_id   (gateway_product_id)
#  index_gateway_plans_on_package_property_id  (package_property_id)
#
