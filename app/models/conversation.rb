...
#  compilation_status          :string(191)
#  deleted_at                  :datetime
#  end_at                      :datetime
#  matched_at                  :datetime
#  result_status               :string(255)
#  start_at                    :datetime
#  status                      :string(191)      not null
#  student_environment_loud    :boolean          default(FALSE)
#  student_evaluation_ability  :integer
#  student_evaluation_fun      :integer
#  student_evaluation_sum      :integer
#  student_evaluation_time     :integer
#  student_memo                :text(65535)
#  student_online_status       :string(255)
#  student_rated               :boolean          default(FALSE)
#  student_report              :string(255)
#  student_report_criminal     :boolean          default(FALSE)
#  student_report_other        :boolean          default(FALSE)
#  student_report_sexual       :boolean          default(FALSE)
#  student_report_solicitation :boolean          default(FALSE)
#  student_report_spam         :boolean          default(FALSE)
#  student_sound_unstable      :boolean          default(FALSE)
#  student_video_invisible     :boolean          default(FALSE)
#  student_video_unstable      :boolean          default(FALSE)
#  teacher_environment_loud    :boolean          default(FALSE)
#  teacher_evaluation_ability  :integer
#  teacher_evaluation_fun      :integer
#  teacher_evaluation_sum      :integer
#  teacher_evaluation_time     :integer
#  teacher_memo                :text(65535)
#  teacher_online_status       :string(255)
#  teacher_rated               :boolean          default(FALSE)
#  teacher_report              :string(255)
#  teacher_report_criminal     :boolean          default(FALSE)
#  teacher_report_other        :boolean          default(FALSE)
#  teacher_report_sexual       :boolean          default(FALSE)
#  teacher_report_solicitation :boolean          default(FALSE)
#  teacher_report_spam         :boolean          default(FALSE)
#  teacher_sound_unstable      :boolean          default(FALSE)
#  teacher_video_invisible     :boolean          default(FALSE)
#  teacher_video_unstable      :boolean          default(FALSE)
#  video                       :string(191)
#  created_at                  :datetime         not null
#  updated_at                  :datetime         not null
#  admin_user_id               :bigint
#  channel_id                  :string(191)
...
# Indexes
#
#  index_conversations_on_admin_user_id            (admin_user_id)
#  index_conversations_on_channel_id               (channel_id) UNIQUE
#  index_conversations_on_conversation_request_id  (conversation_request_id)
#  index_conversations_on_end_at                   (end_at)
#  index_conversations_on_start_at                 (start_at)
#  index_conversations_on_status                   (status)
#  index_conversations_on_student_id               (student_id)
#  index_conversations_on_teacher_id               (teacher_id)
#
