# == Schema Information
#
# Table name: conversations_reports
#
...
# Indexes
#
#  index_conversations_reports_on_conversation_id  (conversation_id)
#  index_conversations_reports_on_from_user_id     (from_user_id)
#  index_conversations_reports_on_to_user_id       (to_user_id)
#
