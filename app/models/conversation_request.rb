...
# Indexes
#
#  index_conversation_requests_on_conversation_id  (conversation_id)
#  index_conversation_requests_on_from_user_id     (from_user_id)
#  users_conversation_request_unique_index         (conversation_id,from_user_id) UNIQUE
#
