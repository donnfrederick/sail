...
#  max_absence_percentage           :integer          default(0)
#  max_discommunication_percentage  :integer          default(0)
#  max_lateness_percentage          :integer          default(0)
#  max_negative_feedback_percentage :integer          default(0)
#  max_no_video_percentage          :integer          default(0)
#  max_noisy_place_percentage       :integer          default(0)
#  min_conversation_count           :integer          default(0)
